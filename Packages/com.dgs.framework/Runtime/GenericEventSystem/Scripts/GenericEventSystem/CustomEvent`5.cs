...
{
    public class CustomEvent<T1, T2, T3, T4, T5> : BaseCustomEvent<Action<T1, T2, T3, T4, T5>, CustomEvent<T1, T2, T3, T4, T5>.Args>
    {
        public struct Args
        {
            public T1 arg1;
        ...
        internal sealed override void Add0ArgsListener(BaseAction baseAction)
        {
            try
            {
                ...
                ActionConverter0Args<T1, T2, T3, T4, T5> actionConverter = new ActionConverter0Args<T1, T2, T3, T4, T5>(action);
        ...
        internal sealed override void Add1ArgsListener(BaseAction baseAction)
        {
            try
            {
                ...
                ActionConverter1Args<T1, T2, T3, T4, T5> actionConverter = new ActionConverter1Args<T1, T2, T3, T4, T5>(action);
                AddListener(actionConverter);
            }
            catch (InvalidCastException)
            {
        ...
        internal sealed override void Add2ArgsListener(BaseAction baseAction)
        {
            try
            {
                ...
                ActionConverter2Args<T1, T2, T3, T4, T5> actionConverter = new ActionConverter2Args<T1, T2, T3, T4, T5>(action);
                AddListener(actionConverter);
            }
            catch (InvalidCastException)
            {
        ...
        internal sealed override void Add3ArgsListener(BaseAction baseAction)
        {
            try
            {
                ...
                ActionConverter3Args<T1, T2, T3, T4, T5> actionConverter = new ActionConverter3Args<T1, T2, T3, T4, T5>(action);
                AddListener(actionConverter);
            }
            catch (InvalidCastException)
            {
        ...
        internal sealed override void Add4ArgsListener(BaseAction baseAction)
        {
            try
            {
                ...
                ActionConverter4Args<T1, T2, T3, T4, T5> actionConverter = new ActionConverter4Args<T1, T2, T3, T4, T5>(action);
                AddListener(actionConverter);
            }
            catch (InvalidCastException)
            {
        ...
        protected override BaseCustomAction<Action<T1, T2, T3, T4, T5>> GetCustomAction(Action<T1, T2, T3, T4, T5> action)
        {
            return new CustomAction<T1, T2, T3, T4, T5>(action);
        }

        protected override void InvokeEvent(IActionReference<Action<T1, T2, T3, T4, T5>> actionReference, Args args)
        {
            if (SystemSettings.m_CatchExceptions)
            {
                try
                {
                    actionReference.Action?.Invoke(args.arg1, args.arg2, args.arg3, args.arg4, args.arg5);
                }
                catch (Exception exception)
                {
                    LogException(exception, actionReference, args.arg1, args.arg2, args.arg3, args.arg4, args.arg5);
                }
            }
            else
            {
